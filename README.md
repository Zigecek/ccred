...
```sh
curl -fsSLO https://github.com/Zigecek/ccred/releases/download/v0.2.9/ccred_0.2.9_amd64.deb
sudo apt install ./ccred_0.2.9_amd64.deb
```
...
```sh
# Linux and macOS
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/Zigecek/ccred/releases/download/v0.2.9/ccred-installer.sh | sh
```

```powershell
# Windows
powershell -ExecutionPolicy Bypass -c "irm https://github.com/Zigecek/ccred/releases/download/v0.2.9/ccred-installer.ps1 | iex"
```
