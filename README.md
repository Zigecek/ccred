...
```sh
curl -fsSLO https://github.com/Zigecek/ccred/releases/download/v0.2.19/ccred_0.2.19_amd64.deb
sudo apt install ./ccred_0.2.19_amd64.deb
```
...
```sh
# Linux and macOS
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/Zigecek/ccred/releases/download/v0.2.19/ccred-installer.sh | sh
```

```powershell
# Windows
powershell -ExecutionPolicy Bypass -c "irm https://github.com/Zigecek/ccred/releases/download/v0.2.19/ccred-installer.ps1 | iex"
```
