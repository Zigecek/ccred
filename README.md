...
```sh
curl -fsSLO https://github.com/Zigecek/ccred/releases/download/v0.2.41/ccred_0.2.41_amd64.deb
sudo apt install ./ccred_0.2.41_amd64.deb
```
...
```sh
curl -fsSLO https://github.com/Zigecek/ccred/releases/download/v0.2.41/ccred_0.2.41_amd64.deb.sha256
sha256sum -c ccred_0.2.41_amd64.deb.sha256
gh attestation verify ccred_0.2.41_amd64.deb --repo Zigecek/ccred
```
...
```sh
# Linux and macOS
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/Zigecek/ccred/releases/download/v0.2.41/ccred-installer.sh | sh
```

```powershell
# Windows
powershell -ExecutionPolicy Bypass -c "irm https://github.com/Zigecek/ccred/releases/download/v0.2.41/ccred-installer.ps1 | iex"
```
